...
class SalesDeal(Base):
    ...
    customer_rate = Column(Numeric(32, 4), nullable=False)
    ...
    def __init__(self, id=None, user_id=None, currency_id=None, interoffice_rate=None, customer_rate=None, base_currency_closing_rate=None, amount=None):
        self.id = id
